...
export default function Hero() {
  ...
  const isDesktop = useMediaQuery(theme.breakpoints.up('md')); // equivale ao min-width: 900px
  return (
    <>
      {/* pc S */}
      {isDesktop ? (
        ...
        >
          ...
          >
            <Image
              ...
              alt="Família feliz"
              fill
              priority                 // só aqui, não no mobile
              sizes="(max-width: 899px) 0px, 70vw" // <900px não usa esta imagem
              quality={70}
              style={{
                objectFit: 'cover',
        ...
        >
          ...
          <Image
            ...
            alt="Família feliz"
            fill
            priority                 // só no mobile, quando mobile
            sizes="100vw"
            quality={70}
            style={{
              objectFit: 'cover',
